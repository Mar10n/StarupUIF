<?php
    ...
    for ($i = 0; $i < $rowCount; $i++) {
        ...
        echo
            ...
            <p>Dato:{$eventrow[$i]['EMaxPart']}</p>
            <p>Dato:{$eventrow[$i]['ECurrPart']}</p>
            <p>Dato:{$eventrow[$i]['EContactName']}</p>
            <p>Dato:{$eventrow[$i]['EContactPhone']}</p>
            <p>Dato:{$eventrow[$i]['ECreatedBy']}</p>
