            ...
            <article>
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    ...
                    <p class="form-group">
                        ...
                        <textarea placeholder="Indtast beskrivelse..." style="resize: none;"><?php echo "{$eventrow[0]['EContactPhone']}"?></textarea>
                    </p>
                    <p class="form-group">
                        <label for="eventImage">Upload et billede til/af arrangement:</label>
                        <input type="file" name="eventImage" value="<?php echo "{$eventrow[0]['EContactPhone']}"?>">
                    </p>
                    <p class="form-group">
                    ...
                    <p class="form-group">
                        ...
                        <input type="number" name="eventMaxDelt" value="<?php echo "{$eventrow[0]['EContactPhone']}"?>">
                    </p>
                    <p class="form-group">
